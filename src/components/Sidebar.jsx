...
export default function Sidebar({ open, onToggleSidebar }) {
  return (
    <aside
    className={`md:rounded-tr-2xl  fixed z-50 top-0 left-0 w-2/3 sm:w-2/4 px-0  md:px-8 py-18 md:w-72 h-full bg-white text-blue-900 transition-transform duration-500 ease-in-out shadow-lg
